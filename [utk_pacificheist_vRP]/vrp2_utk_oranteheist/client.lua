...
--UTK.CurrentRequestId, UTK.ServerCallbacks, UTK.TriggerServerCallback = exports["utk_callback"]:GetData() -- Get Callbakcs
...
function vRPoranteheist:sendAlert(type, output)
 -- exports["mythic_notify"]:SendAlert(type, output)
 exports.pNotify:SetQueueMax("left", 1)
 exports.pNotify:SendNotification({
    text = output,
    type = "error",
    timeout = math.random(3000, 3500),
    layout = "centerLeft",
    queue = "left"
 })
end
...
function vRPoranteheist:HandleInfo()
if not self.remote.policeCheck() then -- vRP Stuff
        if UTK.info.stage == 0 then
            Citizen.CreateThread(function()
                while true do
                    local coords = GetEntityCoords(PlayerPedId())

                       local dst = GetDistanceBetweenCoords(coords, UTK.loudstart.x, UTK.loudstart.y, UTK.loudstart.z, true)
                        ...
                        if dst <= 6 then
							...
							if self.remote.startevent(1) then
                                        UTK.initiator = true
                                        UTK.info.stage = 1
                                        UTK.info.style = 1
                                        UTK.currentplant = 0
                        ...
                        local dst2 = GetDistanceBetweenCoords(coords, UTK.silentstart.x, UTK.silentstart.y, UTK.silentstart.z, true)
                        ...
                        if dst2 <= 6 then
							...
							if self.remote.startevent(2) then
                                        UTK.initiator = true
                                        UTK.info.stage = 1
                                        UTK.info.style = 2
                                        UTK.currentpick = 0
        ...
        elseif UTK.info.stage == 1 then
            if UTK.initiator then
                if UTK.info.style == 1 then
                    Citizen.CreateThread(function()
                        while true do
                            local coords = GetEntityCoords(PlayerPedId())

                            if not UTK.checks.hack1 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.hack1.x, UTK.hack1.y, UTK.hack1.z, true)

                                if dst <= 4 then
                                    DrawText3D(UTK.hack1.x, UTK.hack1.y, UTK.hack1.z, UTK.text.usehack, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
										if self.remote.checkItem("laptop_h") then
                                                ...
                                                exports.pNotify:SetQueueMax("left", 1)
                                                exports.pNotify:SendNotification({
                                                    text = "You don't have a hacker laptop.",
                                                    type = "error",
                                                    timeout = math.random(3000, 3500),
                                                    layout = "centerLeft",
                                                    queue = "left"
                            ...
                            if UTK.checks.hack1 and not UTK.checks.hack2 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.hack2.x, UTK.hack2.y, UTK.hack2.z, true)
                ...
                elseif UTK.info.style == 2 then
                    Citizen.CreateThread(function()
                        while true do
                            local coords = GetEntityCoords(PlayerPedId())

                            if not UTK.checks.id1 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.card1.x, UTK.card1.y, UTK.card1.z, true)

                                if dst <= 4 then
                                    DrawText3D(UTK.card1.x, UTK.card1.y, UTK.card1.z, UTK.text.usecard, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        if self.remote.checkItem("id_card") then
                                            UTK.checks.id1 = true
                                            UTK.currentid = 1
                                            self:IdCard()
                                        else
                                            ...
                                            exports.pNotify:SetQueueMax("left", 1)
                                            exports.pNotify:SendNotification({
                                                text = "You don't have the ID Card.",
                                                type = "error",
                                                timeout = math.random(3000, 3500),
                                                layout = "centerLeft",
                                                queue = "left"
                            ...
                            if UTK.checks.id1 and not UTK.checks.id2 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.card2.x, UTK.card2.y, UTK.card2.z, true)
                    ...
                    Citizen.CreateThread(function()
                        while true do
                            ...
                            if not UTK.checks.thermal1 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.thermal1.x, UTK.thermal1.y, UTK.thermal1.z, true)

                                if dst <= 4 then
                                    DrawText3D(UTK.thermal1.x, UTK.thermal1.y, UTK.thermal1.z, UTK.text.usethermal, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        if self.remote.checkItem("thermal_charge") then
                                                ...
                                                exports.pNotify:SetQueueMax("left", 1)
                                                exports.pNotify:SendNotification({
                                                    text = "You don't have any thermal charges.",
                                                    type = "error",
                                                    timeout = math.random(3000, 3500),
                                                    layout = "centerLeft",
                                                    queue = "left"
                            ...
                            if UTK.checks.thermal1 and not UTK.checks.thermal2 then
                                local dst = GetDistanceBetweenCoords(coords, UTK.thermal2.x, UTK.thermal2.y, UTK.thermal2.z, true)
                        ...
                        Citizen.CreateThread(function()
                            while true do
                                ...
                                if not UTK.checks.lockpick1 then
                                    local dst = GetDistanceBetweenCoords(coords, UTK.lockpick1.x, UTK.lockpick1.y, UTK.lockpick1.z, true)

                                    if dst <= 4 then
                                        DrawText3D(UTK.lockpick1.x, UTK.lockpick1.y, UTK.lockpick1.z, UTK.text.uselockpick, 0.40)
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            if self.remote.checkItem("lockpick") then
                                                    ...
                                                    exports.pNotify:SetQueueMax("left", 1)
                                                    exports.pNotify:SendNotification({
                                                        text = "You don't have any lockpicks.",
                                                        type = "error",
                                                        timeout = math.random(3000, 3500),
                                                        layout = "centerLeft",
                                                        queue = "left"
                                ...
                                if not UTK.checks.lockpick2 then
                                    local dst = GetDistanceBetweenCoords(coords, UTK.lockpick2.x, UTK.lockpick2.y, UTK.lockpick2.z, true)
    ...
    elseif self.remote.policeCheck() then -- CHANGE HERE!
        Citizen.CreateThread(function()
		
            self.remote.GetDoors()
...
function vRPoranteheist:Plant()
    ...
    if UTK.currentplant == 0 then
        ...
        method = 1
    elseif UTK.currentplant == 1 then
        loc.x = 252.95
        loc.y = 220.70
        loc.z = 101.76
        loc.h = 160
        ...
        rotplus = 170.0
        method = 2
    elseif UTK.currentplant == 2 then
        loc.x = 261.65
        loc.y = 215.60
        loc.z = 101.76
        loc.h = 252
    ...
    exports['progressBars']:startUI(4500, UTK.text.thermal)
    Citizen.Wait(1500)
    ...
    Citizen.Wait(4000)
    exports['progressBars']:startUI(12000, UTK.text.burning)
    DeleteObject(bag)
    ...
    UTK.disableinput = false
    if UTK.currentplant == 0 then
        TriggerServerEvent("utk_oh:fixdoor", UTK.doorchecks[1].h, vector3(UTK.doorchecks[1].x, UTK.doorchecks[1].y, UTK.doorchecks[1].z), UTK.doorchecks[1].he)
    elseif UTK.currentplant == 1 then
        TriggerServerEvent("utk_oh:fixdoor", UTK.doorchecks[4].h, vector3(UTK.doorchecks[4].x, UTK.doorchecks[4].y, UTK.doorchecks[4].z), UTK.doorchecks[4].he)
    elseif UTK.currentplant == 2 then
        TriggerServerEvent("utk_oh:fixdoor", UTK.doorchecks[5].h, vector3(UTK.doorchecks[5].x, UTK.doorchecks[5].y, UTK.doorchecks[5].z), UTK.doorchecks[5].he)
    end
    ...
    Citizen.Wait(9000)
    --exports['mythic_notify']:SendAlert("success", UTK.text.melted)
    exports.pNotify:SetQueueMax("left", 1)
    exports.pNotify:SendNotification({
        text = UTK.text.melted,
        type = "error",
        timeout = math.random(3000, 3500),
        layout = "centerLeft",
        queue = "left"
    ...
    if UTK.currentplant == 0 then
        TriggerServerEvent("utk_oh:toggleDoor", newmodel, vector3(UTK.loudstart.x, UTK.loudstart.y, UTK.loudstart.z), false)
        self:HandleInfo()
    elseif UTK.currentplant == 1 then
        TriggerServerEvent("utk_oh:toggleDoor", newmodel, vector3(UTK.inside1.x, UTK.inside1.y, UTK.inside1.z), false)
    elseif UTK.currentplant == 2 then
        TriggerServerEvent("utk_oh:toggleDoor", newmodel, vector3(UTK.inside2.x, UTK.inside2.y, UTK.inside2.z), false)
    end
end

function vRPoranteheist:Lockpick()
    UTK.disableinput = true
    local loc = {x,y,z,h}
    if UTK.currentpick == 0 then
        loc.x = 236.22
        loc.y = 227.50
        loc.z = 105.00
        loc.h = 336.56
    elseif UTK.currentpick == 1 then
        loc.x = 253.28
        loc.y = 221.25
        loc.z = 100.50
        loc.h = 155.11
    elseif UTK.currentpick == 2 then
        loc.x = 260.91
        loc.y = 215.93
        loc.z = 100.50
        loc.h = 248.54
    ...
    exports['progressBars']:startUI(6000, UTK.text.lockpick..": Stage 1")
    Citizen.Wait(6500)
    --exports['mythic_notify']:SendAlert("success", "Stage 1 "..UTK.text.stage)
    exports.pNotify:SetQueueMax("left", 1)
    exports.pNotify:SendNotification({
        text = "Stage 1 "..UTK.text.stage,
        type = "error",
        timeout = math.random(3000, 3500),
        layout = "centerLeft",
        queue = "left"
    ...
    SetEntityHeading(ped, loc.h)
    TaskPlayAnim(ped, animDict, "a_uncuff", 8.0, 8.0, 6000, 1, 1, 0, 0, 0)
    exports['progressBars']:startUI(6000, UTK.text.lockpick..": Stage 2")
    Citizen.Wait(6500)
    --exports['mythic_notify']:SendAlert("success", "Stage 2 "..UTK.text.stage)
    exports.pNotify:SetQueueMax("left", 1)
    exports.pNotify:SendNotification({
        text = "Stage 2 "..UTK.text.stage,
        type = "error",
        timeout = math.random(3000, 3500),
        layout = "centerLeft",
        queue = "left"
    ...
    if UTK.currentpick == 0 then
        UTK.stage0break = true
        TriggerServerEvent("utk_oh:toggleDoor", UTK.silentstart.type, vector3(UTK.silentstart.x, UTK.silentstart.y, UTK.silentstart.z), false, UTK.silentstart.h)
        self:HandleInfo()
    elseif UTK.currentpick == 1 then
        TriggerServerEvent("utk_oh:toggleDoor", UTK.inside1.type, vector3(UTK.inside1.x, UTK.inside1.y, UTK.inside1.z), false, UTK.inside1.h)
    elseif UTK.currentpick == 2 then
        TriggerServerEvent("utk_oh:toggleDoor", UTK.inside1.type, vector3(UTK.inside2.x, UTK.inside2.y, UTK.inside2.z), false, UTK.inside2.h)
    end
end

function vRPoranteheist:Hack()
    UTK.hackfinish = false
    local loc = {x,y,z,h}

    if UTK.currenthack == 0 then
        UTK.hackmethod = 1
        loc.x = 262.65
        loc.y = 222.75
        loc.z = 105.90
        loc.h = 244.19
    elseif UTK.currenthack == 1 then
        UTK.hackmethod = 2
        loc.x = 253.34
        loc.y = 228.25
        loc.z = 101.39
    ...
    exports.pNotify:SetQueueMax("left", 1)
    exports.pNotify:SendNotification({
        text = "Open My Computer and navigate to HackConnect.exe",
        type = "error",
        timeout = math.random(3000, 3500),
        layout = "centerLeft",
        queue = "left"
...
function vRPoranteheist:IdCard()
    UTK.disableinput = true
    ...
    --local panel = ESX.Game.GetClosestObject(("hei_prop_hei_securitypanel"), pedco) -- Needs to be changed to GetClosestObjectOfType()
    local panel = GetClosestObjectOfType(pedco, 2.2, GetHashKey("hei_prop_hei_securitypanel"), false, false, false)
...
function vRPoranteheist:setInfo(data)
	UTK.info = data
...
AddEventHandler("utk_oh:vault", function(method)
	--local obj = ESX.Game.GetClosestObject(UTK.vault.type, vector3(UTK.vault.x, UTK.vault.y, UTK.vault.z)) -- needs to be changed to GetClosestObjectOfType()
...
AddEventHandler("utk_oh:vaulttimer", function(method)
    if method == 1 then
        -- exports['mythic_notify']:SendAlert("error", "You have 105 seconds until toxic gas comes in.")
        exports.pNotify:SetQueueMax("left", 1)
        exports.pNotify:SendNotification({
            text = "You have 105 seconds until toxic gas comes in.",
            type = "error",
            timeout = math.random(3000, 3500),
            layout = "centerLeft",
            queue = "left"
        ...
        --exports['mythic_notify']:SendAlert("error", "You have 120 seconds until toxic gas comes in.")
        exports.pNotify:SetQueueMax("left", 1)
        exports.pNotify:SendNotification({
            text = "You have 120 seconds until toxic gas comes in.",
            type = "error",
            timeout = math.random(3000, 3500),
            layout = "centerLeft",
            queue = "left"
...
AddEventHandler("utk_oh:gas_c", function()
    Citizen.CreateThread(function()
        ...
        exports.pNotify:SetQueueMax("left", 1)
        exports.pNotify:SendNotification({
            text = "Vault door will close automatically in 60 seconds!",
            type = "error",
            timeout = math.random(3000, 3500),
            layout = "centerLeft",
            queue = "left"
...
--     local player = ESX.GetPlayerData() -- another job checker for notify and blip
...
AddEventHandler("utk_oh:toggleDoor_c", function(door, coord, status)
    local obj = GetClosestObjectOfType(coord, 1.5, GetHashKey(door), false, false, false)
...
function vRPoranteheist:returnDoors(doors)
PoliceDoors = doors
end

function vRPoranteheist:setState()
stateReady = true
end
...
vRPoranteheist.tunnel.setInfo = vRPoranteheist.setInfo
vRPoranteheist.tunnel.sendAlert = vRPoranteheist.sendAlert
vRPoranteheist.tunnel.returnDoors = vRPoranteheist.returnDoors
vRPoranteheist.tunnel.setState = vRPoranteheist.setState
